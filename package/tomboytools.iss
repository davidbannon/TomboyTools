...
#define MyAppName "tomboytools"
#define MyAppVersion "REPLACEME"
#define MyAppPublisher "David Bannon"
#define MyAppURL "https://github.com/davidbannon/TomboyTools"
#define MyAppExeName32 "tomboytools.exe"
#define MyAppExeName64 "tomboytools.exe"

[Setup]
; NOTE: The value of AppId uniquely identifies this application.
; Do not use the same AppId value in installers for other applications.
; (To generate a new GUID, click Tools | Generate GUID inside the IDE.)
AppId={{813B2DAE-9AFC-3519-88B2-EAE16027E476}
AppName={#MyAppName}
...
OutputBaseFilename=tomboytools-setup-{#MyAppVersion}
Compression=lzma
...
Source: "tomboytools-64.exe";     DestDir: "{app}";  DestName: "tomboytools.exe"; Check: Is64BitInstallMode
Source: "tomboytools-32.exe";     DestDir: "{app}";  DestName: "tomboytools.exe"; Check: not Is64BitInstallMode
